package com.distributed.system.web.organization.business.controller;

import com.alibaba.dubbo.rpc.RpcException;
import com.distributed.system.api.organization.business.entity.Goods;
import com.distributed.system.api.organization.business.service.GoodsService;
import com.distributed.system.common.dto.BaseResult;
import com.distributed.system.common.dto.BootStrapTableResult;
import com.distributed.system.common.enums.BizExceptionEnum;
...
public class GoodsController {
    ...
    @ResponseBody
    public BootStrapTableResult<Goods> list(Integer offset, Integer limit,HttpSession session) {
        LOG.info("invoke----------/goods/list");
        LOG.info("staticBasePath ---->{}",session.getAttribute("srBasePath"));
        offset = offset == null ? 0 : offset;//默认便宜0
        limit = limit == null ? 50 : limit;//默认展示50条
        List<Goods> list = goodsService.getGoodsList(offset, limit);
